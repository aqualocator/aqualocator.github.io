...
import OfficeLocatorScreen from './OfficeLocatorScreen.js';
import AboutScreen from './AboutScreen.js';
import AquaDirectoryScreen from './AquaDirectoryScreen.js';
import HomeScreen from './HomeScreen.js';
import DataSheet_emps from './DataSheet_emps.js';
import DataSheet_localizationSheet from './DataSheet_localizationSheet.js';
import DataSheet_depts from './DataSheet_depts.js';
...
class App extends Component {
  constructor(props) {
    ...
    this.dataSheets = {};
    this.dataSheets['emps'] = new DataSheet_emps('emps', this.dataSheetDidUpdate);
    this.dataSheets['localizationSheet'] = new DataSheet_localizationSheet('localizationSheet', this.dataSheetDidUpdate);
    this.dataSheets['depts'] = new DataSheet_depts('depts', this.dataSheetDidUpdate);
    this.dataSheetLoaded = {};

    this.dataSlots = {};
    this.dataSlots['ds_activeLang'] = "en";
    this.dataSlots['ds_aquaemps'] = "AquaDirectory";
  ...
  render() {
    const makeScreen = (screenId, baseProps, atTop, forward, subpathId) => {
      let screenCtxProps = {
        ...
        'ds_aquaemps': this.dataSlots['ds_aquaemps'],
        'ds_filter': this.dataSlots['ds_filter'],
      };
      let screen;
      switch (screenId) {
        case 'officeLocator':
          screen = <OfficeLocatorScreen {...baseProps} />;
          break;
        case 'about':
          screen = <AboutScreen {...baseProps} />;
          break;
        case 'aquaDirectory':
          screen = <AquaDirectoryScreen {...baseProps} />;
          break;
        case 'home':
    ...
    return (
      <div className="App">
        <Switch>
          ...
          <Route path="/officeLocator" render={(props) => {
            return makeScreen('officeLocator', props.location.state, true, true);
          }} />
          <Route path="/about" render={(props) => {
            return makeScreen('about', props.location.state, true, true);
          }} />
          <Route path="/aquaDirectory" render={(props) => {
            return makeScreen('aquaDirectory', props.location.state, true, true);
          }} />
